...
(cl:defmethod cl:initialize-instance :after ((m <Command>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Command)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name first_coursework-msg:<Command> is deprecated: use first_coursework-msg:Command instead.")))

(cl:ensure-generic-function 'command-val :lambda-list '(m))
(cl:defmethod command-val ((m <Command>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader first_coursework-msg:command-val is deprecated.  Use first_coursework-msg:command instead.")
  (command m))

(cl:ensure-generic-function 'value-val :lambda-list '(m))
(cl:defmethod value-val ((m <Command>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader first_coursework-msg:value-val is deprecated.  Use first_coursework-msg:value instead.")
  (value m))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Command>)))
  ...
  (cl:format cl:nil "string command~%int32 value~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Command)))
  "Returns full string definition for message of type 'Command"
  (cl:format cl:nil "string command~%int32 value~%~%"))
